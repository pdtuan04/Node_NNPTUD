...
router.put("/:id/start", CheckLogin, checkRole("ADMIN", "MODERATOR"), async function (req, res) {
...
router.put("/:id/complete", CheckLogin, checkRole("ADMIN", "MODERATOR"), async function (req, res) {
